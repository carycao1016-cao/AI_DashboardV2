...
AI_OUTLINE_TARGET_TOKENS = max(1_000, int(_setting("PARSER_AI_OUTLINE_TARGET_TOKENS", "24000")))
AI_OUTLINE_HARD_TOKENS = max(AI_OUTLINE_TARGET_TOKENS, int(_setting("PARSER_AI_OUTLINE_HARD_TOKENS", "28000")))
